...
function Holders({totalDividendsDistributed,ethPrice}) {
    return (
        ...
        <section className="total_bnb_bg"></section>
            ...
            <h1 className="Dollar"><span>=</span><span>$</span><span>{numberWithCommas(parseFloat(totalDividendsDistributed*ethPrice).toFixed(0))||0}</span></h1>
            </div>
            </section>
    )
}
